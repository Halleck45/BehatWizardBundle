test('Scenario can receive steps', function() {
    ...
    var step1 = new hbw.step('given','I am a logged in user with following');
    step1.outline = outline1;

    var step2 = new hbw.step('then', 'I sould see my name on the screen');
    ...
    var step3 = new hbw.step('given','Another condition');
